...
| 레벨 | 능력 |
| --- | --- |
| 15레벨 | 광물을 캐면 일정 확률로 동전, 은전, 금전이 드랍됨 |
| 30레벨 | 네더라이트 장비(도구)로 업그레이드 가능함, 곡괭이를 들면 성급함 1 |
### 농사
...
- **내구도 수리 스크롤**은 내구도가 존재하고, 내구도가 닳은 장비의 내구도를 **100**만큼 회복 한다.
- **스크롤 조각**은 **5개**를 모으고 **우클릭** 하면 **인챈트 스크롤** 혹은 **내구도 수리 스크롤** 중 랜덤으로 1개 얻을 수 있다.
- **스크롤** 사용 시 1E를 소비한다.
