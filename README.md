...
| 30레벨 | 대장장이 작업대 사용 가능 |
### 농사
- 괭이로 **경작지**를 만들기 위해서는 **경작지 허가**가 필요하다.
- **땅 8개**당 **1E**가 필요하다.
- 괭이로 경작지를 만들 때, **자동으로** E를 소모하여 경작지 허가를 구매한다.
- **30레벨** - 씨앗 **아래쪽을 캐면** 자동으로 심어진 씨앗까지 같이 캐져서 **에임을 중간위**에 둬야한다.

| 레벨 | 능력 |
| --- | --- |
| 15레벨 | 일정 확률로 경작지 허가 차감없이 경작지를 만들 수 있음 |
